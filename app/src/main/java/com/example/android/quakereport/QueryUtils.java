...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            // Extract the JSONArray assiciated with the key called "features",
            ...
            for(int i = 0; i < featuresArray.length(); i++){
                ...
                // Get the feature (earthquake) at number i
                JSONObject features = featuresArray.getJSONObject(i);

                // Get the properties JSONObject
                JSONObject propertiesObject = features.getJSONObject("properties");

                // Store specified variables from the propertiesObject
                ...
                // Add the information to make a new Earthquake
